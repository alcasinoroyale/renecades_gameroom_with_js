...
connect_four = Game.create(name: "Connect Four", description: "Players choose a color and insert their discs into the playing grid.", objective: "Form a horizontal, vertical, or diagonal line of four of your own discs.", number_of_players: "2", reward_points: "50", genre: "Strategy", category_id: "1")
scrabble = Game.create(name: "Scrabble", description: "Word game in which players score points by placing tiles bearing a single letter onto a board divided into a 15x15 grid of squares.", objective: "The player with the highest score wins the game.", number_of_players: "3", reward_points: "90", genre: "Word Game", category_id: "1")
...
grand_theft_auto_V = Game.create(name: "Grand Theft Auto V", description: "Takes place in the fictional state of San Andreas based on Southern California. Player follows three criminals and their efforts to commit hesists while under pressure from a government agency.", objective: "Explore the open world as well as finish the main story to get the full game experience.", number_of_players: "1", reward_points: "100", genre: "First/Third-Person Shooter", category_id: "2")

table = Category.create(name: "Table Games")
air_hockey = Game.create(name: "Air Hockey", description: "Players face off with paddles and a puck.", objective: "The first player to score 7 goals wins the game.", number_of_players: "2", reward_points: "60", genre: "Sport", category_id: "3")
foosball = Game.create(name: "Foosball", description: "Players control knobs to move the ball into the opponent's goal.", objective: "The First player to score 10 goals wins the game.", number_of_players: "2", reward_points: "60", genre: "Sport", category_id: "3")
